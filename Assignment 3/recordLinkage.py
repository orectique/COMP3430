...
datasetA_name = '../Lab 3/datasets/little-dirty-A-10000.csv'
datasetB_name = '../Lab 3/datasets/little-dirty-B-10000.csv'
truthfile_name = '../Lab 3/datasets/little-dirty-true-matches-10000.csv'
...
weight_vec = [math.log2(len(dfA.iloc[:, x].unique()) + len(dfB.iloc[:, x].unique())) for x in attrs]
...
#saveLinkResult.save_linkage_set("data_wrangling_rl_best_results_2023_u7322074.csv", class_match_set=class_match_set)
